    ...
    return (
        ...
        <div className="rounded-lg bg-white p-8 text-slate-900 shadow-inner">
            {blocks.map((block, blockIndex) => {
                ...
                if (block.kind === 'keyValueTable') {
                    return (
                        <table key={blockIndex} className="mt-2 w-full border-collapse text-sm">
                            <tbody>
                ...
                if (block.kind === 'dataTable') {
                    return (
                        <div key={blockIndex} className="mt-2 overflow-x-auto">
                ...
                return (
                    <figure key={blockIndex} className="mt-4">
